export default function VideoCard({index,thumbnail,vindex,videoTitle,date,channel,imgTh,imgThName,onclick}){
    return <div className="details" onClick={onclick}>
    <div className="thumbnail">
        ...
        <div className={"v"+vindex+" duration"}></div>
